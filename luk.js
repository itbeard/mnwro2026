...
const BOW_PARTS = [
  { key: "riser",  x: 151, y: 280, emoji: "🪵", name: "Ручка / дзяржанне",  en: "grip, riser",
  ...
  { key: "limb",   x: 116, y: 150, emoji: "💪", name: "Плечы",              en: "limbs",
    desc: "Верхняе і ніжняе — пругкія часткі, што гнуцца і накопліваюць энергію. У рэкурсіва канцы загнутыя." },
  { key: "string", x: 206, y: 150, emoji: "〰️", name: "Цеціва",             en: "string, bowstring",
    desc: "Злучае канцы плячэй. Менавіта яе мы нацягваем; на ёй — сядло, куды ставім стралу." },
  { key: "rest",   x: 170, y: 272, emoji: "📐", name: "Палічка для стралы", en: "arrow rest",
    desc: "Невялікая апора на ручцы, на якой ляжыць страла да выпуску." },
  { key: "sight",  x: 96,  y: 276, emoji: "🎯", name: "Прыцэл",             en: "pin sight", gear: true,
    desc: "Прыцэл спартыўнага лука — праз яго наводзім на мішэнь. Толькі для спартыўнага абвесу." },
  { key: "stab",   x: 96,  y: 332, emoji: "📏", name: "Стабілізатары",      en: "stabilizers", gear: true,
    desc: "Стрыжні, што гасяць ваганні і ўтрымліваюць лук роўна пры стрэле." },
];

const ARROW_PARTS = [
  { key: "point",  x: 50,  y: 75, emoji: "🔺", name: "Наканечнік", en: "head, point, bullet point",
    desc: "Пярэдні цяжкі канец — уваходзіць у мішэнь. Бывае розны па форме і вазе." },
  { key: "shaft",  x: 245, y: 75, emoji: "🪵", name: "Дрэўка", en: "shaft",
    desc: "Цела стралы. Матэрыял: дрэва, алюміній, карбон ці кампазіт. Даўжыня, гнуткасць (spine) і вага падбіраюцца пад лук." },
  { key: "fletch", x: 448, y: 60, emoji: "🪶", name: "Апярэнне", en: "fletching",
    desc: "Пёры або пластыкавыя лопасці — стабілізуюць палёт і дакладнасць." },
  { key: "nock",   x: 492, y: 75, emoji: "🔗", name: "Хвосцік / нок", en: "nock",
    desc: "Задні прарэз, якім страла ставіцца на цеціву ў сядло." },
];
